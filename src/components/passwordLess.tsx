...
const PasswordLessUp: React.FC<SignInProps> = ({ handleAuthPage }) => {
  ...
  return (
    <div className="authCard">
      ...
      <h4 className="already" onClick={() => handleAuthPage("sign-up")}>
        Use a different sign-up provider
      </h4>
    </div>
  );
};
export default PasswordLessUp;
